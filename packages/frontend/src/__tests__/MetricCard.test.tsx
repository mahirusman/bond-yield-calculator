...
describe('MetricCard', () => {
  ...
  it('renders the title prop', () => {
    render(<MetricCard title="Current Yield" value="6.3158%" description="Annual coupon ÷ market price" />);
  ...
  it('matches the snapshot', () => {
    const { container } = render(
      <MetricCard title="Current Yield" value="6.3158%" description="Annual coupon ÷ market price" />
    );
