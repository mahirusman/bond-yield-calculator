...
const bondSchema = z.object({
  faceValue: decimalField('Face value').refine(
    (value) => parseDecimal(value).gt(0),
  ...
  marketPrice: decimalField('Market price').refine(
    (value) => parseDecimal(value).gt(0),
    'Must be greater than 0'
  ),
  yearsToMaturity: decimalField('Years to maturity').refine(
    (value) => parseDecimal(value).gte(0.5),
    'Must be at least 0.5 years'
  ),
